...
switch (dark) {
  ...
  <div className="container mx-auto flex flex-wrap py-4  flex-row items-center min-[407px]:justify-between justify-center ">
   ...
   {/* <img src="/dadaLogo.png" alt="dadaLogo" className='min-[410px]:h-16 h-12'/> */}
      <p className="ml-3 text-lg min-[480px]:text-3xl font-semibold hover:cursor-pointer pr-2 max-[407px]:text-center">JotDown</p>
    </a>
    <nav className="md:ml-auto max-[456px]:mx-auto flex flex-wrap gap-y-3 items-center text-white justify-center">
      <button id='mode' onClick={toggleDark} className='py-1 w-10  bg-purple-500 shadow-lg ml-2 mr-7 rounded-md'>
